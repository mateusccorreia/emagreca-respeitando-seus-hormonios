...
const learnItems = [
  {
    ...
    description:
      "Cortisol, insulina e tireoide: entenda como cada um impacta o seu peso e quais marcadores observar.",
    icon: <IconMolecule />,
  },
  {
    title: "Ritual matinal anti-inchaço",
    description:
      "Sequência de 10 minutos para reduzir retenção, melhorar digestão e estabilizar o humor logo cedo.",
    icon: <IconSunrise />,
  },
  {
    title: "Prato que equilibra",
    description:
      "Combinações simples de proteínas, fibras e gorduras para saciedade real, sem contar calorias.",
    icon: <IconPlate />,
  },
  {
    title: "Treinos que respeitam o ciclo",
    description:
      "Ajuste intensidade, descanso e alimentação de acordo com cada fase do seu ciclo menstrual.",
    icon: <IconCycle />,
  },
  {
    title: "SOS TPM e cravings",
    description:
      "Micro substituições e timing de nutrientes para controlar compulsão e ansiedade.",
    icon: <IconSpark />,
  },
  {
    title: "Semana modelo",
    description:
      "Roteiro prático de 7 dias com horários, hidratação e ajustes rápidos para manter consistência.",
    icon: <IconCalendar />,
  },
];
...
const finalBenefits = [
  {
    icon: <IconDownload />,
    text: "PDF enxuto e imediato para aplicar hoje, sem enrolação.",
  },
  {
    icon: <IconGuide />,
    text: "Protocolos claros e acompanhados de microcopys de execução.",
  },
  {
    icon: <IconRocket />,
    text: "Porta de entrada para o Desafio 7 Dias — você já sai pronta.",
  },
];
...
const challengeSteps = [
  ...
  },
  {
    ...
    title: "Leitura",
    detail:
      "Guia curto para ler em menos de 1h e começar a aplicar no mesmo dia.",
  },
  {
    step: "03",
    title: "Desafio",
    detail:
      "Receba o convite do Desafio 7 Dias e continue comigo na prática guiada.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-dark-500 text-white font-body overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Right glow */}
        <div
          className="absolute -right-40 top-1/2 h-[500px] w-[500px] rounded-full bg-emerald-600/8 blur-[100px] animate-pulse-slow"
      ...
      <header
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
          scrolled
            ? "bg-dark-500/90 backdrop-blur-lg border-b border-emerald-500/10"
            : ""
        }`}
      >
              ...
              <div className="space-y-8 text-center lg:text-left">
                ...
                <Reveal delay={100}>
                  <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                    Emagreça <span className="gradient-text">respeitando</span>
                    <br />
                    seus hormônios
                  </h1>
                </Reveal>
                ...
                <Reveal delay={200}>
                  <p className="text-lg md:text-xl text-white/70 leading-relaxed max-w-xl mx-auto lg:mx-0">
                    Um guia prático para mulheres que querem perder peso,
                    reduzir inchaço e recuperar energia —
                ...
                <Reveal delay={300}>
                  <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                    {["PDF imediato", "R$ 9,90", "Leitura no celular"].map(
                      (chip, index) => (
                        <span
                          key={chip}
              ...
              <div className="glass-card rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
                ...
                <p className="text-xl md:text-2xl leading-relaxed text-white/90">
                  ...
                  <span className="text-emerald-400 font-semibold">
                    dieta de moda não resolve
                  </span>{" "}
                  e que emagrecer é sobre respeitar hormônios, reduzir
                  inflamação e ajustar rotina. Quer{" "}
                  <span className="text-emerald-400 font-semibold">
                    um roteiro simples, curto e acionável
                  </span>{" "}
                  para recuperar energia, desinchar e voltar a sentir controle
                  do seu corpo.
                </p>
              </div>
            </Reveal>
                  ...
                  <div className="space-y-6">
                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                      <p className="text-white/80 leading-relaxed">
                        ...
                        , especialista em equilíbrio hormonal feminino e
                        nutrição funcional. <br></br>
                        <br></br>
                        <p>
                          Por muitos anos, vivi a frustração de tentar emagrecer
                          e sentir que o corpo não respondia. Passei por
                          gestações, alterações hormonais, cansaço constante e a
                          sensação de estar sempre lutando contra mim mesma. Foi
                          nesse processo que entendi algo essencial: o problema
                          não era falta de esforço, era falta de escuta. Quando
                          comecei a respeitar meus hormônios, meu ritmo e meus
                          sinais internos, o emagrecimento deixou de ser
                          sofrimento e passou a ser consequência.
                        </p>
                      </p>
                    </div>
                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
                      <p className="text-white/80 leading-relaxed">
                        Meu método combina ciência, rotina viável e escuta
                        ativa: ajusto alimentação, ritmo de treino e recuperação
                        para que você respeite seu ciclo, reduza inflamação e
                        mantenha energia estável.
                      </p>
                    </div>
              ...
              <div className="relative glass-card-light rounded-3xl p-8 md:p-12 overflow-hidden">
                <div className="relative z-10">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-6">
                    ...
                    <CTAButton
                      href="https://pay.hotmart.com/H41400094U"
                      className="w-full lg:w-auto"
                      label="👉 Quero meu e-book agora"
                    />
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/50">
              <div className="flex items-center gap-3">
                ...
                <span>|</span>
                <span>
                  Conteúdo educativo. Não substitui acompanhamento individual.
                </span>
              </div>
  ...
  return (
    <div className={`flex items-center gap-3 ${sizeClasses}`}>
      <div
        ...
        } rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white font-display font-bold shadow-glow`}
      >
        K
      </div>
      <div>
